...
συνδιάζοντας διάφορα περιφερειακά εξαρτήματα, όπως αισθητήρες και κινητήρες. Πρόκειται για μια νέα εκπαιδευτική πλατφόρμα με πολλές 
...
Συνεπώς, με τις κατασκευές που βασίζονται στο Micro:bit ξεκινούν να παρατηρούν, να αναρωτιούνται, να φαντάζονται και να δημιουργούν 
έξυπνες διεπαφές, οι οποίες είναι φιλικές προς τον χρήστη, και αρκετές φορές ενσωματομένες στο περιβάλλον του. Με άλλα λόγια, απλά και διασκεδαστικά συστήματα βασιμένα στις αρχές του διάχυτου υπολογισμού.
